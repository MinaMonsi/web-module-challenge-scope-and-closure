...
1. In your own words, define closure (1-2 sentences).
   ...
   Closures gives us the ability to put functions together. It accesses functions from a parent level scope in child level scope even after the parent function has been terminated.
...
The return function is where the function personalDice is closed.
